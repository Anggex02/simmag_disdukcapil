    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <form action="{{ route('mahasiswa.store') }}" method="POST">
            ...
            <div class="flex justify-end gap-3 mt-8">
                ...
                <a href="{{ route('mahasiswa.index') }}" class="px-5 py-3 rounded-xl bg-gray-600 hover:bg-gray-700">

                    Batal

                </a>

                <button type="submit" class="px-5 py-3 rounded-xl bg-primary hover:opacity-90 text-white">
